      ...
      <tbody>
        ${filteredPrograms.map(programa => `
          <tr>
            ...
            <td>${programa.tipo || 'N/A'}</td>
            <td><span class="status-badge status-${programa.estado.toLowerCase()}">${programa.estado}</span></td>
            <td>
              <button class="btn btn-sm btn-primary" data-program-id="${programa._id}">
